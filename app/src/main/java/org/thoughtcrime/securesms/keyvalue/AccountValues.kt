...
internal class AccountValues internal constructor(store: KeyValueStore) : SignalStoreValues(store) {
  ...
  public override fun getKeysToIncludeInBackup(): List<String> {
    return listOf(
      ...
      KEY_SERVICE_PASSWORD,
      KEY_REGISTRATION_ID,
      KEY_FCM_ENABLED,
      KEY_FCM_TOKEN,
      KEY_FCM_TOKEN_VERSION,
      KEY_FCM_TOKEN_LAST_SET_TIME,
      KEY_DEVICE_NAME,
      KEY_DEVICE_ID,
      KEY_PNI_REGISTRATION_ID,
      KEY_ACI_SIGNED_PREKEY_REGISTERED,
      KEY_ACI_NEXT_SIGNED_PREKEY_ID,
      KEY_ACI_ACTIVE_SIGNED_PREKEY_ID,
      KEY_ACI_SIGNED_PREKEY_FAILURE_COUNT,
      KEY_ACI_NEXT_ONE_TIME_PREKEY_ID,
      KEY_PNI_SIGNED_PREKEY_REGISTERED,
      KEY_PNI_NEXT_SIGNED_PREKEY_ID,
      KEY_PNI_ACTIVE_SIGNED_PREKEY_ID,
      KEY_PNI_SIGNED_PREKEY_FAILURE_COUNT,
      KEY_PNI_NEXT_ONE_TIME_PREKEY_ID,
      KEY_IS_REGISTERED,
      KEY_E164,
      KEY_ACI,
      KEY_PNI
